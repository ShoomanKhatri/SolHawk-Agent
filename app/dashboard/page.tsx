...
import { Eye, RefreshCw, Send, Plus, Search, Filter, Wallet } from "lucide-react";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      // Sort in memory since index is missing
      docs.sort((a, b) => {
        ...
        {!connected ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-400 mb-10 max-w-md">
              Please connect your Solana wallet to access your dashboard and manage your invoices.
            </p>
            <WalletConnectButton />
          </div>
        ) : (
